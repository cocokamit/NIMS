...
public class inventory_info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(store.get("iCategory").equals("Food"))
        {
            itemcategory.setSelection(0);
        }
        else if(store.get("iCategory").equals("Item"))
        {
            itemcategory.setSelection(1);
        }
        else if(store.get("iCategory").equals("Toys"))
        {
        ...
        imagedelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(inventory_info.this);
                ...
                builder.setPositiveButton("Confirm",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                params.put("Id", store.get("iId"));

                                PerformNetworkRequest request = new PerformNetworkRequest(Api.URL_DELETE_ITEM, params, CODE_POST_REQUEST, getApplicationContext());
                                request.execute();
        ...
        imagepetid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ImagePicker.with(inventory_info.this)
                        .cropSquare()
                        .compress(1024)
    ...
    private void RegisterPet() {
        ...
        if(bitmap!=null){
            ...
            PerformNetworkRequest request = new PerformNetworkRequest(Api.URL_UPDATE_ITEM, params, CODE_POST_REQUEST, this);
            request.execute();
        }
        else
        {
            ...
            try {
                if(this.connection){
                    ...
                    if (!object.getBoolean("error")) {
                        ...
                        if(object.getString("message").equals("Item updated successfully"))
                        {
                            onBackPressed();
                        }
                        else{
